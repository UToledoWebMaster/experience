...
const AcademicSuccessContentUniversity = ({ state }) => {
     const data = useStaticQuery(graphql`
     query universityAcademicSuccess {
     ...
     `)
     // const universityAcademicSuccess = data.images.nodes.filter(node => node.name === 'universityAcademicSuccess')[0];
          ...
          return (
               <>
                    <Row>
                         <FullWidth>
                              <h1>Find Support</h1>
                              {/* <Img className="anim" fadeIn={true} fluid={universityAcademicSuccess.childImageSharp.fluid} /> */}
...
export default AcademicSuccessContentUniversity;