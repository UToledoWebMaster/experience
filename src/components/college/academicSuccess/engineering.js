...
const AcademicSuccessContentEngineering = ({ state }) => {
     const data = useStaticQuery(graphql`
     query engineeringAcademicSuccess {
                    ...
                    <Row>
                         <HalfColumn>
                              ...
                              <ul>
                                   ...
                                   <li>Pre-Health Advising Center for pre-med and other healthcare majors</li>
...
export default AcademicSuccessContentEngineering;