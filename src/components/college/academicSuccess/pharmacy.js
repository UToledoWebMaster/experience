...
const AcademicSuccessContentPharmacy = ({ state }) => {
     const data = useStaticQuery(graphql`
     query pharmacyAcademicSuccess {
     ...
     `)
     const pharmacyAcademicSuccess = data.images.nodes.filter(node => node.name === 'pharmacyAcademicSuccess')[0];
          ...
          return (
               <>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={pharmacyAcademicSuccess.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br />
                    <SingleTestimony>
                         ...
                         <ThreeQuarterColumn>
                              <div className="headshotQuote__text">
                                   ...
                                   <p className="collegeTestimonySubtitle">Defiance, Ohio</p>
...
export default AcademicSuccessContentPharmacy;