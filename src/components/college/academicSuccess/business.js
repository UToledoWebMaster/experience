...
const AcademicSuccessContentBusiness = ({ state }) => {
     ...
     `)
     // const businessAcademicSuccess = data.images.nodes.filter(node => node.name === 'businessAcademicSuccess')[0];
          ...
          return (
               <>
                    <Row>
                         <FullWidth>
                              <h1>Find Support</h1>
                              {/* <Img className="anim" fadeIn={true} fluid={businessAcademicSuccess.childImageSharp.fluid} /> */}
