...
const AcademicSuccessContentHealth = ({ state }) => {
     const data = useStaticQuery(graphql`
     query healthAcademicSuccess {
     ...
     `)
     // const healthAcademicSuccess = data.images.nodes.filter(node => node.name === 'healthAcademicSuccess')[0];
          ...
          return (
               <>
                    <Row>
                         <FullWidth>
                              <h1>Find Support</h1>
                              {/* <Img className="anim" fadeIn={true} fluid={healthAcademicSuccess.childImageSharp.fluid} /> */}
...
export default AcademicSuccessContentHealth;