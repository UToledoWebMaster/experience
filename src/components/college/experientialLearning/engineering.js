                         ...
                         <Slider>
                              ...
                              <div className="row skyBack">
                                   <div className="nine columns">
                                        <div className="headshotQuote__text">
                                             ...
                                             <p>Class of 2020, chemical engineering | Toledo, Ohio</p>
                              ...
                              <div className="row skyBack">
                                   <div className="nine columns">
                                        <div className="headshotQuote__text">
                                             <h2>John Sims</h2>
                                             <p>Class of 2021, computer science engineering technology | Toledo, Ohio</p>
                              ...
                              <div className="row skyBack">
                                   <div className="nine columns">
                                        <div className="headshotQuote__text">
                                             <h2>Evan Reed</h2>
                                             <p>Class of 2019, electrical engineering | Carleton, Mich.</p>
