                         ...
                         <Slider className="testimonialSlider">
                              ...
                              <div className="row skyBack">
                                   ...
                                   <div className="nine columns">
                                        <div className="headshotQuote__text">
                                             ...
                                             <p className="collegeTestimonySubtitle">Chemical Engineering '20 | Toledo, Ohio</p>
                              ...
                              <div className="row skyBack">
                                   ...
                                   <div className="nine columns">
                                        <div className="headshotQuote__text">
                                             <h2>John Sims</h2>
                                             <p className="collegeTestimonySubtitle">Computer Science Engineering Technology '21 | Toledo, Ohio</p>
                              ...
                              <div className="row skyBack">
                                   ...
                                   <div className="nine columns">
                                        <div className="headshotQuote__text">
                                             <h2>Evan Reed</h2>
                                             <p className="collegeTestimonySubtitle">Electrical Engineering '19 | Carleton, Mich.</p>
