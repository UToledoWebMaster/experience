...
const ResearchContentPharmacy = ({ state }) => {
     const data = useStaticQuery(graphql`
     query pharmacyResearch {
     ...
     const pharmacyResearch = data.images.nodes.filter(node => node.name === 'pharmacyResearch')[0];
     if (state) {
          return (
               <>
                    <Row>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={pharmacyResearch.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br /><br />
...
export default ResearchContentPharmacy;