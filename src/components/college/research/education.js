...
const ResearchContentEducation = ({ state }) => {
     const data = useStaticQuery(graphql`
     query educationResearch {
          ...
          return (
               <>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={educationResearch.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br /><br />
...
export default ResearchContentEducation;