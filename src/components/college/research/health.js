...
const ResearchContentHealth = ({ state }) => {
     const data = useStaticQuery(graphql`
     query healthResearch {
     ...
     const healthResearch = data.images.nodes.filter(node => node.name === 'healthResearch')[0];
     if (state) {
          return (
               <>
                    <Row>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={healthResearch.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br /><br />
...
export default ResearchContentHealth;