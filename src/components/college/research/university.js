...
const ResearchContentUniversity = ({ state }) => {
     const data = useStaticQuery(graphql`
     query universityResearch {
     ...
     const universityResearch = data.images.nodes.filter(node => node.name === 'universityResearch')[0];
     if (state) {
          return (
               <>
                    <Row>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={universityResearch.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br /><br />
                    ...
                    <SingleTestimony>
                         ...
                         <ThreeQuarterColumn>
                              <div className="headshotQuote__text">
                                   ...
                                   <p className="collegeTestimonySubtitle">Oak Harbor, Ohio</p>
...
export default ResearchContentUniversity;