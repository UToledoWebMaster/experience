...
const ResearchContentNursing = ({ state }) => {
     const data = useStaticQuery(graphql`
     query nursingResearch {
     ...
     const nursingResearch = data.images.nodes.filter(node => node.name === 'nursingResearch')[0];
     if (state) {
          return (
               <>
                    <Row>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={nursingResearch.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br /><br />
...
export default ResearchContentNursing;