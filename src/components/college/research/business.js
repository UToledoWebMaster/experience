...
const ResearchContentBusiness = ({ state }) => {
     const data = useStaticQuery(graphql`
     query businessResearch {
          ...
          return (
               <>
                    ...
                    <Row>
                         ...
                         <HalfColumn>
                              <Img className="anim" fadeIn={true} fluid={businessResearch.childImageSharp.fluid} />
                         </HalfColumn>
                    </Row>
                    <br /><br />
...
export default ResearchContentBusiness;