...
const HonorsContentUniversity = ({ state }) => {
     const data = useStaticQuery(graphql`
     query universityHonors {
                    ...
                    <SingleTestimony>
                         ...
                         <ThreeQuarterColumn>
                              <div className="headshotQuote__text">
                                   ...
                                   <p className="collegeTestimonySubtitle">Class of 2019 | Chicago, Ill.</p>
...
export default HonorsContentUniversity;